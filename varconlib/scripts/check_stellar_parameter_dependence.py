...
def main():
    ...
    labels = ['4219.893V1_16', '4492.660Fe2_25', '4653.460Cr1_29',
              '4767.190Mn1_33', '5138.510Ni1_42', '5200.158Fe1_43',
              '5571.164Fe1_50', '6067.161Fe1_59', '6192.900Ni1_61']
        ...
        for time in eras.keys():
            ...
            for name in tqdm(arrays_dict.keys()):
                ...
                for bin_lims in pairwise(bin_dict[name]):
                    ...
                    sigma_list.append(np.std(residuals_copy))
    ...
    file_name = Path('/Users/dberke/Pictures/'
                     f'sigma_sys_stellar_parameter_dependance/Combined.png')
    # plt.show()
