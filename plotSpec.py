...
parser.add_argument('-n', '--minx', action='store', default=378,
                    type=float,
                    help='The min x value (in nm).')
parser.add_argument('-m', '--maxx', action='store', default=692,
                    type=float,
...
solarSpectrum = "/Users/dberke/Documents/IAG_solar_atlas_V1_405-1065.txt"
if args.sun:
